...
# add a legend
legend(.5,4,c("Prior (based on belief)","Posterior (updated with data)"), lty=c(3,2),lwd=c(3,3), col=c("black","red"))
```
...
For example, is it likely that the proportion of heavy sleepers is greater than .5? This is answered by computing the posterior probability $Pr(p \geq .5 \rvert data)$
